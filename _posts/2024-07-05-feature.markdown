...
<div style="display: flex; flex-wrap: wrap;">
  <img src="{{ site.baseurl }}/assets/features/result1.JPG" alt="result1" style="margin: 3px;" />
  <img src="{{ site.baseurl }}/assets/features/result2.JPG" alt="result2" style="margin: 3px;" />
</div>
